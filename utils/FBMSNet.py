...
class MixedConv2d(nn.ModuleDict):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=3,
        ...
        in_splits = _split_channels(in_channels, num_groups) # [3 2 2 2]
        out_splits = _split_channels(out_channels, num_groups) # [9 9 9 9]
    ...
    def forward(self, x):
        x_split = torch.split(x, self.splits, 1) # 将输入频带(维度)按照卷积尺度划分组
...
class FBMSNet(nn.Module):
    ...
    def LastBlock(self, inF, outF, doWeightNorm=True, *args, **kwargs):
        return nn.Sequential(
            ...
            nn.LogSoftmax(dim=1))
    def __init__(self, fs, nChan, nTime, nClass=4, temporalLayer='LogVarLayer', num_Feat=36, dilatability=8, dropoutP=0.5, *args, **kwargs):
        ...
        self.mixConv2d = nn.Sequential(
            MixedConv2d(in_channels=12, out_channels=num_Feat, kernel_size=[(1,15),(1,31),(1,63),(1,125)],
...
#     net = FBMSNet(nChan=62, nTime=1000, nClass=15).cuda()
#     summary(net, (9, 62, 1000))
